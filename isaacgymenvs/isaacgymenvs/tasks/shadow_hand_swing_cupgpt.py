...
class ShadowHandSwingCupGPT(VecTask):
    ...
    def compute_observations(self):
        ...
        self.goal_rot3 = self.LAPP_get_euler_xyz(self.goal_rot)
        self.object_rot3 = self.LAPP_get_euler_xyz(self.object_rot)
    ...
    def _create_recording_camera(self, env_idx=0, width=1280, height=720):
        ...
        cam_pos = gymapi.Vec3(-0.5, -1.0, 1.0)
        cam_target = gymapi.Vec3(0.0, -1.0, 0.5)
...
@torch.jit.script
def LAPP_compute_reward(object_pos: torch.Tensor, 
